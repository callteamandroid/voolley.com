...
<body>
    ...
    <table id="compras" class="table table-bordered">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td><?php echo $resultado['noOrden']; ?></td>
                    <td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $productos = json_decode($resultado['prodOriginal'], true);
                                                if (!empty($productos)) {
                                                    foreach ($productos as $producto) {
                                                        echo "<tr>";
                                                        echo "<td>" . htmlspecialchars($producto['noParte']) . "</td>";
                    ...
                    <td><?php echo $resultado['planta']; ?></td>
                    <td>
